...
public class ArduinoControl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Bundle addressBundle = newint.getExtras(); //receive the address of the bluetooth

        if (savedInstanceState ==null) {
            if (addressBundle != null) {
                //TODO here get the string stored in the string variable and do
                // setText() on userName
                address = addressBundle.getString("EXTRA_ADDRESS");
            }
        }
        else {
            address= (String) savedInstanceState.getSerializable("EXTRA_ADDRESS");
        }
